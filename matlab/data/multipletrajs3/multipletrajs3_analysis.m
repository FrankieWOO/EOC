...
%%
fprintf('---------| accuracy | accu. halt. | overshot | avg. settle time | Erege | Kinetic |\n')
fprintf('constant | %4.4f    | %4.8f | %4.4f| %4.4f | %4.4f |%4.4f |\n',summary.data1.accuracy_score,summary.data1.accuracy_halt,summary.data1.avg_overshot,summary.data1.avg_settle_time,summary.data1.avg_Erege,summary.data1.avg_kinetic)
fprintf('vary damp| %4.4f    | %4.8f | %4.4f| %4.4f | %4.4f |%4.4f |\n',summary.data2.accuracy_score,summary.data2.accuracy_halt,summary.data2.avg_overshot,summary.data2.avg_settle_time,summary.data2.avg_Erege,summary.data2.avg_kinetic)
fprintf('optimal  | %4.4f    | %4.8f | %4.4f| %4.4f | %4.4f |%4.4f |\n',summary.data3.accuracy_score,summary.data3.accuracy_halt,summary.data3.avg_overshot,summary.data3.avg_settle_time,summary.data3.avg_Erege,summary.data3.avg_kinetic)
...
[p1,v1,acc1,t1,power_rege1,segments1,target_lines1]=DataProcess.merge_traj_list(data1(1:10,1), ws1.target_list(1:10), 1.5);
[p2,v2,acc2,t2,power_rege2,segments2,target_lines2]=DataProcess.merge_traj_list(data2(1:10,1), ws2.target_list(1:10), 1.5);
[p3,v3,acc3,t3,power_rege3,segments3,target_lines3]=DataProcess.merge_traj_list(data3(1:10,1), ws3.target_list(1:10), 1.5);
